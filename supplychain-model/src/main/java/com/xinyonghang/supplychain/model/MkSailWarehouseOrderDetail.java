...
@Table(name = "MK_SAIL_WAREHOUSE_ORDER_DETAIL")
public class MkSailWarehouseOrderDetail {
    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;

    @Column(name = "SAIL_WAREHOUSE_CODE")
    private String sailWarehouseCode;
    ...
    /**
     * @return SAIL_WAREHOUSE_CODE
     */
    public String getSailWarehouseCode() {
        return sailWarehouseCode;
    }

    /**
     * @param sailWarehouseCode
     */
    public void setSailWarehouseCode(String sailWarehouseCode) {
        this.sailWarehouseCode = sailWarehouseCode;
    }
