...
var editSkuMethodUrl = {
    // 新增属性保存
    editAttribute: window.baseUrl + "/mk/sku/attribute/update",

    // 查询属性detail
    getAttributeDetail: window.baseUrl + "/mk/sku/attribute/detail",
...
$(function () {
    ...
    function getAttributeDetail() {
        $.ajax({
            url: editSkuMethodUrl.getAttributeDetail,
            type: "post",
    ...
    function editAttribute() {
        $.ajax({
            url: editSkuMethodUrl.editAttribute,
            type: "post",
    ...
    function getCategoryList(parentId, level) {
        $.ajax({
            url: editSkuMethodUrl.getCategoryList,
            type: "post",
