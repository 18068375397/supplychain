//修改源码，添加秒钟选择下拉框--by sumingguang
//修改，限定可选日期后，月份无法选择的问题
!function ($) {
    function UTCDate() {
    ...
    Datetimepicker.prototype = {
        constructor: Datetimepicker, _events: [], _attachEvents: function () {
            ...
            var addSec = /,s{1,2},/.test("," + this.format.parts.join(",") + ","),
                sSec = addSec ? '<select class="form-control input-sm">' : "";
            this.addSec = addSec;
            if (addSec) {
                var orgSec = this.viewDate.getSeconds();
                for (var _i = 0; _i < 60; _i++) {
                    sSec += '<option value="' + _i + '"' + (_i == orgSec ? " selected" : "") + ">" + (_i < 10 ? "0" : "") + _i + "</option>"
                }
                sSec += "</select>"
            }
