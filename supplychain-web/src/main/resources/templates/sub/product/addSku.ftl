    ...
    <form class="form-horizontal" id="validForm" name="validForm" v-cloak>
        <div class="form-group">
            ...
            <div class="col-sm-all col-sm-3">
                <input class="form-control" id="skuAttrId" name="skuAttrId"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-all col-sm-3">
                <input class="form-control" id="skuAttrName" name="skuAttrName"/>
            </div>
        </div>
...
<script type="text/javascript" src="${request.contextPath}/static/js/sub/product/addSku.js"></script>
</body>
</html>