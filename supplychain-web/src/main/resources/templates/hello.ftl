...
<#-- 将下面这个main content嵌入到layout指令的nested块中 -->
    <div class="col-md-9 bootstrap-admin-col-right">
        <ul class="nav nav-tabs" role="tablist" id="main-ul">
            <li id="main-tab"><a href="#identifier" data-toggle="tab">Home</a></li>
        </ul>
        <div class="tab-content">
            <div id="identifier" class="tab-pane active" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">yonghu</div>
...
<script type="text/javascript" src="${request.contextPath}/static/js/sub/hello.js"></script>
</@defaultLayout.layout>