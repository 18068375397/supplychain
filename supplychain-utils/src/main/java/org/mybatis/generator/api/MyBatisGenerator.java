...
public class MyBatisGenerator {
    ...
    public MyBatisGenerator(Configuration configuration, ShellCallback shellCallback,
                            List<String> warnings, String appXmlStr, String tableName) throws InvalidConfigurationException {
        super();
        this.appXmlStr = appXmlStr;
    ...
    private void writeFile(File file, String content, String fileEncoding) throws IOException {
        ...
        if (content.indexOf("</mapper>") != -1) {
            content = content.replace("</mapper>", "  " + appXmlStr + "\r\n</mapper>");
        }

        if (file.getName().contains("Mapper.java")) {
            StringBuffer sb = new StringBuffer();
            sb.append("package com.xinyonghang.supplychain.dao;\r\n\r\n");
            sb.append("import com.xinyonghang.supplychain.core.Mapper;\r\n");
            sb.append("import java.util.List;\r\n");
            sb.append("import com.xinyonghang.supplychain.dto." + tableName + "Dto;\r\n");
            sb.append("import com.xinyonghang.supplychain.model." + tableName + ";\r\n\r\n");
            sb.append("public interface " + tableName + "Mapper extends Mapper<" + tableName + ">{\r\n");
            sb.append("List<" + tableName + "> findList(" + tableName + "Dto " + tableName.substring(0, 1).toLowerCase() + tableName.substring(1) + "Dto);");
            sb.append("\r\n}");
            content = sb.toString();
        }
        bw.write(content);
